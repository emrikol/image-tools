#!/usr/bin/env python3
"""
plot-savings.py — render assets/savings.png from assets/savings-data.json.
(Run measure-sizes.mjs first to generate the data.)
...
fig.suptitle(
    "How much smaller — same image, same quality, modern format",
    color=FG,
    fontsize=16,
    fontweight="bold",
    y=0.98,
...
fig.text(
    0.5,
    0.005,
    "Each point: the file shrinks this much with no visible quality loss. "
